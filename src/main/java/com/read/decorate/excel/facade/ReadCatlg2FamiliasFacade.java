...
public class ReadCatlg2FamiliasFacade implements Execute{
	...
	public static void main(String[] args) {
		...
		ReadCatlg2FamiliasFacade readCatalogoFacade = new ReadCatlg2FamiliasFacade("FAMILIAS",355, 3, path);
		readCatalogoFacade.procesar();
	}

	public ReadCatlg2FamiliasFacade(EntityManager manager) {
		this.manager = manager;
	}

	public ReadCatlg2FamiliasFacade(String sheet, int rowEnd,int col, String path) {
		super();
		this.sheet = sheet;
		this.col = col;
		this.path = path;
