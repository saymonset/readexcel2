...
public class ReadCatlg3ClasesFacade  implements Execute{
	...
	public static void main(String[] args) {
		...
		ReadCatlg3ClasesFacade readCatalogoFacade = new ReadCatlg3ClasesFacade("CLASES",2079, 3, path);
		readCatalogoFacade.procesar();
	}

	public ReadCatlg3ClasesFacade(EntityManager manager) {
		this.manager = manager;
	}

	public ReadCatlg3ClasesFacade(String sheet, int rowEnd,int col, String path) {
		super();
		this.sheet = sheet;
		this.col = col;
		this.path = path;
